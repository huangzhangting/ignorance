package nom.ignorance.component.utils.http;
...
public class HttpClientUtil {
    ...
    public static HttpClientResult postJson(String url, String jsonString) {
        HttpPost request = new HttpPost(url);
        request.addHeader("Content-Type", "application/otherTest.json;charset=UTF-8");
        request.addHeader("Accept", "application/otherTest.json");
